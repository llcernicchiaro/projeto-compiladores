...
{
       0,    68,    68,    89,    90,    93,    94,    95,    98,    99,
     100,   103,   104,   105,   108,   111,   112,   115,   118,   119,
     122,   125,   128,   131,   132,   135,   138,   141,   144,   145,
     148,   149,   150,   151,   152,   153,   154,   155,   158,   159,
     162,   165,   166,   169,   172,   173,   176,   177,   180,   183,
...
#line 68 "parser.y"
                          { (yyval.ast) = (yyvsp[0].ast); 
                            TAC *taclist;
                            FILE *asmOut = fopen("asm.s", "w");
                            astPrint((yyvsp[0].ast),0); 
                            generateSource((yyvsp[0].ast), out);
                            checkAndSetDeclarations((yyvsp[0].ast));
                            checkUndeclared((yyvsp[0].ast));
                            checkUseOf((yyvsp[0].ast));
                            checkOperands((yyvsp[0].ast));
                            checkParameters((yyvsp[0].ast));
                            checkGlobalVectorDeclaration((yyvsp[0].ast));
                            checkFunctionsReturnType((yyvsp[0].ast));
                            checkAssignmentsType((yyvsp[0].ast));
                            taclist = tacGenerateCode((yyvsp[0].ast));
                            tacPrintBack(taclist);
                            generateASM(reverse(taclist), asmOut);
                            if (semanticErrors > 0)
                              exit(4);
                          }
#line 1501 "y.tab.c"
...
#line 1567 "y.tab.c"
  ...
  case 14:
#line 108 "parser.y"
                                     { (yyval.ast) = astCreate(AST_LITERAL_LIST, 0, (yyvsp[-1].ast), (yyvsp[0].ast), 0, 0); }
#line 1573 "y.tab.c"
    break;

  case 15:
#line 111 "parser.y"
                                          { (yyval.ast) = astCreate(AST_LITERAL_LIST_TAIL, 0, (yyvsp[-1].ast), (yyvsp[0].ast), 0, 0); }
#line 1579 "y.tab.c"
    break;
...
#line 1585 "y.tab.c"
  ...
  case 17:
#line 115 "parser.y"
                                { (yyval.ast) = astCreate(AST_INITIALIZATION, 0, (yyvsp[-1].ast), 0, 0, 0); }
#line 1591 "y.tab.c"
    break;

  case 18:
#line 118 "parser.y"
                                     { (yyval.ast) = astCreate(AST_OPTIONAL_INITIALIZATION, 0, (yyvsp[0].ast), 0, 0, 0); }
#line 1597 "y.tab.c"
    break;
...
#line 1603 "y.tab.c"
  ...
  case 20:
#line 122 "parser.y"
                                                                 { (yyval.ast) = astCreate(AST_GLOBAL_VARIABLE_DECLARATION, (yyvsp[-2].symbol), (yyvsp[-3].ast), (yyvsp[-1].ast), 0, 0); }
#line 1609 "y.tab.c"
    break;

  case 21:
#line 125 "parser.y"
                                                                                           { (yyval.ast) = astCreate(AST_GLOBAL_VECTOR_DECLARATION, (yyvsp[-5].symbol), (yyvsp[-6].ast), astCreate(AST_SYMBOL, (yyvsp[-3].symbol), 0, 0, 0, 0), (yyvsp[-1].ast), 0); }
#line 1615 "y.tab.c"
    break;
...
#line 1621 "y.tab.c"
  ...
  case 23:
#line 131 "parser.y"
                                              { (yyval.ast) = astCreate(AST_OPTIONAL_PARAMS_LIST, 0, (yyvsp[-1].ast), (yyvsp[0].ast), 0, 0); }
#line 1627 "y.tab.c"
    break;
...
#line 1651 "y.tab.c"
  ...
  case 28:
#line 144 "parser.y"
                                             { (yyval.ast) = astCreate(AST_CMD_LIST_TAIL, 0, (yyvsp[-1].ast), (yyvsp[0].ast), 0, 0); }
#line 1657 "y.tab.c"
    break;
...
#line 1717 "y.tab.c"
  ...
  case 39:
#line 159 "parser.y"
                                                                { (yyval.ast) = astCreate(AST_ASSIGNMENT, (yyvsp[-5].symbol), (yyvsp[-3].ast), (yyvsp[0].ast), 0, 0); }
#line 1723 "y.tab.c"
    break;
...
#line 1729 "y.tab.c"
  ...
  case 41:
#line 165 "parser.y"
                                  { (yyval.ast) = astCreate(AST_OPTIONAL_INDEX, 0, (yyvsp[-1].ast), 0, 0, 0); }
#line 1735 "y.tab.c"
    break;
...
#line 1759 "y.tab.c"
  ...
  case 46:
#line 176 "parser.y"
                                             { (yyval.ast) = astCreate(AST_PRINT_PARAM_LIST, 0, (yyvsp[-1].ast), (yyvsp[0].ast), 0, 0); }
#line 1765 "y.tab.c"
    break;
...
#line 1807 "y.tab.c"
  ...
  case 54:
#line 194 "parser.y"
                                            { (yyval.ast) = astCreate(AST_ARRAY_ACCESS, (yyvsp[-3].symbol), (yyvsp[-1].ast), 0, 0, 0); }
#line 1813 "y.tab.c"
    break;
...
#line 1843 "y.tab.c"
  ...
  case 60:
#line 200 "parser.y"
                                            { (yyval.ast) = astCreate(AST_GREATER_THAN, 0, (yyvsp[-2].ast), (yyvsp[0].ast), 0, 0); }
#line 1849 "y.tab.c"
    break;

  case 61:
#line 201 "parser.y"
                                            { (yyval.ast) = astCreate(AST_LESS_THAN, 0, (yyvsp[-2].ast), (yyvsp[0].ast), 0, 0); }
#line 1855 "y.tab.c"
    break;
...
#line 1897 "y.tab.c"
  ...
  case 69:
#line 209 "parser.y"
                                            { (yyval.ast) = astCreate(AST_BRACKETS_EXPR, 0, (yyvsp[-1].ast), 0, 0, 0); }
#line 1903 "y.tab.c"
    break;
...
#line 1915 "y.tab.c"
  ...
  case 72:
#line 216 "parser.y"
                                                    { (yyval.ast) = astCreate(AST_PARAMS_FUNC_CALL, 0, (yyvsp[-1].ast), (yyvsp[0].ast), 0, 0); }
#line 1921 "y.tab.c"
    break;
